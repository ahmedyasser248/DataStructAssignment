...
public class makeMails {
  public static void def()  {//should be first thing to run on program ;
    ...
    Contact user1=new Contact("user1","user1u","user1p","none");
    Contact user2=new Contact("user2","user2u","user2p","none");
    Contact user3=new Contact("user3","user3u","user3p","none");
    try {
      file1.mkdir();
      file2.createNewFile();
      App obj = new App();
