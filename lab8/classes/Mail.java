...
public class Mail implements IMail {
  ...
  public Mail(String indexString){
    String[] indexInfo = indexString.split(" ");
    this.sender = indexInfo[1];
    this.receivers = indexInfo[3];
    this.importance = indexInfo[7];
    this.subject = indexInfo[5];
    DateTimeFormatter dtf=DateTimeFormatter.ofPattern("yyyy,MM,dd,HH,mm,ss");
    this.dateReceived = LocalDateTime.from(dtf.parse(indexInfo[9]));
  }
